...
public class MainController {
    ...
    public String add(@RequestParam(value = "name", required = false) String name,@RequestParam(value = "body", required = false) String body,@RequestParam(value = "putdate", required = false) Date putdate,@RequestParam Map<String, String> params,Model model) {
    ...
    public String update(@RequestParam(value = "name", required = false) String name,@RequestParam Map<String, String> params,@RequestParam(value = "putdate", required = false) Date putdate,@RequestParam(value = "idNews", required = false) Long idNews,@RequestParam(value = "body", required = false) String body,Model model) {
        List<Long> idsCategory = new ArrayList<>();
        List<CategoryDTO> categories =categoryService.findCategories();
